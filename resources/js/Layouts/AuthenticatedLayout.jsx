            ...
            <nav className="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <a 
                                    ...
                                    href='images/Uputstvo za Aplikaciju OpenRev.pdf'
                                >
                                    Uputstvo
                                </a>
                            </div>
                ...
                >
                    ...
                    <div className="space-y-1 pb-3 pt-2">
                        <a
                            target='_blank'
                            className={'inline-flex items-center border-b-2 px-5 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 focus:border-gray-300 focus:text-gray-700 dark:text-gray-400 dark:hover:border-gray-700 dark:hover:text-gray-300 dark:focus:border-gray-700 dark:focus:text-gray-300'}
                            href='images/Uputstvo za Aplikaciju OpenRev.pdf'
                            active=''
                        >
                            Uputstvo
